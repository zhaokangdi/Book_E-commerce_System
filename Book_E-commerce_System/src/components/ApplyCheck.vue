            ...
            <div>
              <el-form :label-position="labelPosition" label-width="80px" :model="apply">
                ...
                <el-form-item label="联系方式">
                  <el-input autocomplete="off" style="width: 450px" v-model="apply.phone"></el-input>
                </el-form-item>

                <el-form-item label="通讯地址">
                  <el-input autocomplete="off" style="width: 450px" v-model="apply.address"></el-input>
                </el-form-item>

                <el-form-item label="店铺名称">
                  <el-input autocomplete="off" style="width: 450px" v-model="apply.storeName"></el-input>
                </el-form-item>

                <el-form-item label="店铺简介">
                  <el-input type="textarea" :rows="5" style="width: 450px" v-model="apply.introduction"></el-input>
                </el-form-item>
              </el-form>
